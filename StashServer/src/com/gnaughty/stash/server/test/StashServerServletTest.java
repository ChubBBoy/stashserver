...
public class StashServerServletTest {
...
//		String servletURLString = "http://localhost:8888/account/retrieve";
		...
		JSONObject jsonObject = new JSONObject();
		try {
			jsonObject.accumulate(Account.ID, 6002);
			jsonObject.accumulate(Account.AUTHENTICATION_KEY, "91e12c4ac1c14fcaab5c3a74dce19cc9");
			String result = invokeServlet(servletURLString, jsonObject.toString());
			System.out.println(result);
		} catch (Exception e) {
			fail(e.getMessage());
